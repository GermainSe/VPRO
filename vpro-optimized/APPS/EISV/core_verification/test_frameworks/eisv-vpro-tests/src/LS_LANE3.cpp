...
int main(int argc, char *argv[]) {
    ...
    __vpro(L1, NONBLOCKING, NO_CHAIN, FUNC_AND, NO_FLAG_UPDATE, DST_ADDR(0, 1, 8),
                                    SRC1_LS_2D, SRC2_CHAINING_LEFT_2D, 7, 7);
    vpro_wait_busy(0xffffffff, 0xffffffff);

    //ST (from: 0, size: 64, to: 128) reverse schedule
    __vpro(L1, NONBLOCKING, IS_CHAIN, FUNC_ADD, NO_FLAG_UPDATE, DST_ADDR(0, 1, 8),
                                    SRC1_ADDR(0, 1, 8), SRC2_IMM_2D(0), 7, 7);
//    __vpro(LS, NONBLOCKING, NO_CHAIN, FUNC_STORE, NO_FLAG_UPDATE, DST_ADDR(128, 1, 8),
//                                    SRC1_CHAINING_2D(1), SRC2_IMM_2D(0), 7, 7);
