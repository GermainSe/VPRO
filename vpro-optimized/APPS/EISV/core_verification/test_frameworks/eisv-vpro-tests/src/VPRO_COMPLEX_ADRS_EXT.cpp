...
// V1                // ADD
    __vpro(L0, NONBLOCKING, NO_CHAIN, FUNC_ADD, NO_FLAG_UPDATE, DST_ADDR(0, 1, 16),
           SRC1_ADDR(0, 1, 16), SRC2_IMM_2D(0x1234), 15, 63);

// V2                //ST (from: 0, size: 64, to: 1024)
    __vpro(L0, NONBLOCKING, IS_CHAIN, FUNC_ADD, NO_FLAG_UPDATE, DST_ADDR(0, 16, 1),
           SRC1_ADDR(0, 16, 1), SRC2_IMM_2D(0), 63, 15);

    VPRO::DIM2::LOADSTORE::store(1024,
                                 0, 16, 1,
                                 63, 15,
                                 L0);
//    __vpro(LS, NONBLOCKING, NO_CHAIN, FUNC_STORE, NO_FLAG_UPDATE, DST_ADDR(0, 16, 1),
//           SRC1_CHAINING_2D(0), SRC2_IMM_2D(1024), 63, 15);
