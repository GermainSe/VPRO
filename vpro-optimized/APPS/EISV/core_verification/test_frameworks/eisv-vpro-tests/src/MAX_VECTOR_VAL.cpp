...
int main(int argc, char *argv[]) {
    ...
    __vpro(L0, NONBLOCKING, IS_CHAIN, FUNC_MAX_VECTOR, NO_FLAG_UPDATE, DST_ADDR(0, 1, 8),
                                    SRC1_ADDR(0, 1, 8), SRC2_ADDR(0,1,8), 7, 7);       // 1 = index
...
//                                    SRC1_CHAINING_2D(0), SRC2_IMM_2D(0), 7, 7);
    vpro_wait_busy(0xffffffff, 0xffffffff);
    dma_l2e_1d(0b1, 0b1, uint64_t(intptr_t(&(result_array[0]))), 128, 64);
    dma_wait_to_finish(0xffffffff);
