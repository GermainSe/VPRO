...
//LD (from: 512, size: 64, to: 512)
    __vpro(LS, NONBLOCKING, IS_CHAIN, FUNC_LOADS, NO_FLAG_UPDATE, DST_ADDR(0, 1, 8),
           SRC1_ADDR(0, 1, 8), SRC2_IMM_2D(512),
           7, 7);
// ADD 0
...
//           SRC1_CHAINING_2D(0), SRC2_IMM_2D(0),
//           7, 7);
