...
int main(int argc, char *argv[]) {
    ...
    __vpro(LS, NONBLOCKING, IS_CHAIN, FUNC_LOADBS, FLAG_UPDATE, DST_ADDR(0, 1, 8),
...
//                                    SRC1_CHAINING_2D(0), SRC2_IMM_2D(0), 7, 7);
    ...
    __vpro(L0, NONBLOCKING, IS_CHAIN, FUNC_ADD, NO_FLAG_UPDATE, DST_ADDR(192, 1, 8),
                                    SRC1_ADDR(512, 1, 8), SRC2_IMM_2D(0), 7, 7);
    //ST (from: 512, size: 64, to: 192)
    VPRO::DIM2::LOADSTORE::store(0,
                                 192, 1, 8,
                                 7, 7,
                                 L0);
//    __vpro(LS, NONBLOCKING, NO_CHAIN, FUNC_STORE, NO_FLAG_UPDATE, DST_ADDR(192, 1, 8),
//                                    SRC1_CHAINING_2D(0), SRC2_IMM_2D(0), 7, 7);
    vpro_wait_busy(0xffffffff, 0xffffffff);
    dma_loc_to_ext();
    dma_wait_to_finish(0xffffffff);
