...
volatile COMMAND_DMA::COMMAND_DMA __attribute__ ((aligned (16))) __attribute__ ((section (".nobss_32byte_align"))) dmas;
...
int main(int argc, char *argv[]) {
    ...
    dmas.direction = COMMAND_DMA::DMA_DIRECTION::e2l2D;
    dmas.cluster = 0b1;
    dmas.unit_mask = 0b11;
    dmas.mm_addr = intptr_t(&(test_array_1[0]));
    dmas.mm_addr_64 = intptr_t(&(test_array_1[0])) >> 32;
    dmas.lm_addr = 128;
    dmas.y_leap = 2;
    dmas.x_size = 8;
    dmas.y_size = 8;
    dmas.padding = 1 << COMMAND_DMA::PAD::BOTTOM;
    dma_block_size(1);
