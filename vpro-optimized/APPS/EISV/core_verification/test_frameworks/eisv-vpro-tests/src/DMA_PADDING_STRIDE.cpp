...
int main(int argc, char *argv[]) {
    ...
    pad_flags[COMMAND_DMA::PAD::TOP] = true;
    pad_flags[COMMAND_DMA::PAD::RIGHT] = true;
    pad_flags[COMMAND_DMA::PAD::BOTTOM] = true;
    pad_flags[COMMAND_DMA::PAD::LEFT] = true;

    //init to 0
    dma_e2l_1d(0b1, 0b1, uint64_t(intptr_t(result_array_zeros)), 128, NUM_TEST_ENTRIES);
    dma_e2l_2d(0b1, 0b1, uint64_t(intptr_t(&(test_array_1[0]))), 128, 8, 8, 2, pad_flags);
    dma_wait_to_finish(0xffffffff);
