...
//    aux_clr_sys_time();
      uint32_t startclock = aux_get_CNT_RISC_TOTAL();
...
//    // flush after last layer
//    if (xli == bnet->layer_execlist_count - 1)
//        dcma_flush();
