...
#        print('Loading... "{}"' .format(bin_path[i]))
    ...
    print("\tLoaded ", out_channels, "Elements")
...
if __name__ == '__main__':
    ...
    out_fraction_bits = 8  # precision of result
...
#    c_out_bin_path = '../data/reference/binary/Layer_7/channel_'
#    c_out_bin_path = '../data/reference_c/binary/Layer_7/reference_out_'
#    c_out_bin_path = '/home/gesper/repositories/CORE_VPRO/sw/vpro/cnn_yolo_lite/data/vpro_result/binary/Layer_7/channel_'
    c_out_bin_path = '/home/gesper/repositories/CORE_VPRO/sw/vpro/cnn_yolo_lite/tf_ref/data/tf_reference/binary/Layer_6/tf_rf_7x7_'
    ...
    print(np.min(c_predictions))
    print(np.max(c_predictions))
    ...
    tf_out_bin_path = '/home/gesper/repositories/CORE_VPRO/sw/vpro/cnn_yolo_lite/tf_ref/data/tf_reference/binary/Layer_6/tf_rf_7x7_'
