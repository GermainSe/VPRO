...
Abs::Abs(LANE lane,
    ...
    : Processing(lane,
          ...
          update_flags,
          blocking) {}
void Abs::vproInstruction() {
    VPRO::DIM3::PROCESSING::abs(getLane(),
        getDst()->getAddress(),
        getSrc1()->getAddress(),
        getSrc2()->getAddress(),
        getXEnd(),
...
void Abs::riscvInstruction(int32_t* rf,
    int16_t* lm,
    const size_t& x,
    const size_t& y,
    const size_t& z,
