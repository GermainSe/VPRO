...
void RANDOM_XOR::xoroshiro128plus_seed_with(const uint64_t x) {
    s[0] = splitmix64next(x);
    s[1] = splitmix64next(s[0]);
}

void RANDOM_XOR::xoroshiro128plus_seed_auto() {
    xoroshiro128plus_seed_with(time_based_x());
}
...
uint64_t RANDOM_XOR::xoroshiro128plus_next() {
