...
void
padding_bottom_right_test(volatile int16_t *test_array_1, volatile int16_t *test_array_2,
                          volatile int16_t *result_array) {
    sim_printf("Testing Padding Bottom Right DMA Instructions\n");
