...
void
padding_top_right_test(volatile int16_t *test_array_1, volatile int16_t *test_array_2, volatile int16_t *result_array) {
    sim_printf("Testing Padding Top Right DMA Instructions\n");
