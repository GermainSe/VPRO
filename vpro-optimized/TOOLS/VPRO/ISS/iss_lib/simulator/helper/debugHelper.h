...
enum DebugOptions {
    ...
    DEBUG_LANE_ACCU_RESET = 1 << 27,  // resets of accu generate a print message
    end = 1 << 28   /*** TODO: when add nes, update this index + add label for GUI (debugHelper.cpp) */
};  // last: 12
