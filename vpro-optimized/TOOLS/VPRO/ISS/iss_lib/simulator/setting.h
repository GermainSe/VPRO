...
/**
 * OPB of DSP in MUL/MAC takes 18-bit if FPGA implementation is used.
 * ISS can check for overflows
 */
constexpr bool CHECK_MUL_OPERAND_WIDTH_OVERFLOW = true;
extern bool CHECK_MUL_OPERAND_WIDTH_OVERFLOW_WARNING_WAS_PRINTED;    // just print once...

/**
 * RF read access is checked.
 * If an address is read which was never written, this check will print a message / exit
 */
constexpr bool CHECK_RF_UNINITIALIZED_ACCESS = false;
constexpr bool EXIT_ON_RF_UNINITIALIZED_ACCESS = true;
...
constexpr char CMD_HISTORY_FILE_NAME[] = "../sim_cmd_history.log";

constexpr bool CREATE_CMD_ISSUE_FILE = false;
constexpr char CMD_ISSUE_FILE_NAME[] = "../sim_cmd_issue.cpp.log";
