...
[[nodiscard]] __attribute__((unused)) static const char* print(LANE l) {
    switch (l) {
        case L0:
            return "L0";
        case L1:
...
[[nodiscard]] __attribute__((unused)) static const char* printLANE(LANE l) {
    switch (l) {
        case L0:
            return "L0";
        case L1:
...
#define OPCODE_DIVL         0b10000  // hardware unsupported OPCODE! (+ 5 bit!)
#define OPCODE_DIVH         0b10001  // hardware unsupported OPCODE! (+ 5 bit!)
// actual operation ("function macro")
...
#define FUNC_DIVL	  FUNC(CLASS_ALU, OPCODE_DIVL)    // hardware unsupported OPCODE! (+ 5 bit!)
#define FUNC_DIVH     FUNC(CLASS_ALU, OPCODE_DIVH)   // hardware unsupported OPCODE! (+ 5 bit!)
...
// Special class
#define OPCODE_SHIFT_LL     0b0000   // hardware unsupported OPCODE!
...
// actual operation ("function macro")
#define FUNC_SHIFT_LL     FUNC(CLASS_SPECIAL, OPCODE_SHIFT_LL)   // hardware unsupported OPCODE!
...
#define FUNC_NOP         FUNC(CLASS_TRANSFER, OPCODE_NOP)
...
#define SRC_SEL_NEIGHBOR          0b011
#define SRC_SEL_INDIRECT_LS       0b100
#define SRC_SEL_INDIRECT_NEIGHBOR 0b101
#define SRC_SEL_INDIRECT_LS_LANE0 0b110
#define SRC_SEL_INDIRECT_LS_LANE1 0b111

// deprecated -> update code, TODO: remove
//#define SRC_SEL_RIGHT SRC_SEL_NEIGHBOR
//#define SRC_SEL_LEFT SRC_SEL_NEIGHBOR
//#define SRC_SEL_INDIRECT_RIGHT SRC_SEL_INDIRECT_NEIGHBOR
//#define SRC_SEL_INDIRECT_LEFT SRC_SEL_INDIRECT_NEIGHBOR
...
constexpr unsigned int min(unsigned int a, unsigned int b){
    if (a < b)
        return a;
    return b;
}
...
constexpr unsigned int ISA_SEL_LENGTH = 3;

constexpr unsigned int DATAPATH_WIDTH = 24; // e.g. limit for immediate values
...
constexpr unsigned int ISA_IMMEDIATE_MASK_3D = 0xffffffffu >> (32-min(ISA_COMPLEX_LENGTH_3D, DATAPATH_WIDTH));
constexpr unsigned int ISA_COMPLEX_MASK_2D = 0xffffffffu >> (32-ISA_COMPLEX_LENGTH_2D);
constexpr unsigned int ISA_SEL_LEN_MASK = 0xffffffffu >> (32-ISA_SEL_LENGTH);
...
// address
#define DST_ADDR(...) PP_MACRO_OVERLOAD(ADDR, __VA_ARGS__)
#define SRC_ADDR(...) PP_MACRO_OVERLOAD(ADDR, __VA_ARGS__)
#define SRC1_ADDR(...) PP_MACRO_OVERLOAD(ADDR, __VA_ARGS__)
#define SRC2_ADDR(...) PP_MACRO_OVERLOAD(ADDR, __VA_ARGS__)
#define ADDR_3(offset, alpha, beta)         complex_ADDR_2D(SRC_SEL_ADDR, offset, alpha, beta)
#define ADDR_4(offset, alpha, beta, gamma)  complex_ADDR_3D(SRC_SEL_ADDR, offset, alpha, beta, gamma)
...
#define DST_INDIRECT_LEFT_0()  complex_ADDR_3D((uint32_t) SRC_SEL_INDIRECT_NEIGHBOR, 0, 0, 0, 0)
#define DST_INDIRECT_LEFT_3(alpha, beta, gamma) complex_ADDR_3D((uint32_t) SRC_SEL_INDIRECT_NEIGHBOR, 0, alpha, beta, gamma)
...
#define DST_INDIRECT_RIGHT_0()  complex_ADDR_3D((uint32_t) SRC_SEL_INDIRECT_NEIGHBOR, 0, 0, 0, 0)
#define DST_INDIRECT_RIGHT_3(alpha, beta, gamma) complex_ADDR_3D((uint32_t) SRC_SEL_INDIRECT_NEIGHBOR, 0, alpha, beta, gamma)
...
#define SRC_INDIRECT_LEFT_0()  complex_ADDR_3D((uint32_t) SRC_SEL_INDIRECT_NEIGHBOR, 0, 0, 0, 0)
#define SRC_INDIRECT_LEFT_3(alpha, beta, gamma)  complex_ADDR_3D((uint32_t) SRC_SEL_INDIRECT_NEIGHBOR, 0, alpha, beta, gamma)
...
#define SRC_INDIRECT_RIGHT_0()  complex_ADDR_3D((uint32_t) SRC_SEL_INDIRECT_NEIGHBOR, 0, 0, 0, 0)
#define SRC_INDIRECT_RIGHT_3(alpha, beta, gamma)  complex_ADDR_3D((uint32_t) SRC_SEL_INDIRECT_NEIGHBOR, 0, alpha, beta, gamma)

// indirect source addressing: in LS, select lane
#define SRC_INDIRECT_LANE0(...) PP_MACRO_OVERLOAD(SRC_INDIRECT_LANE0, __VA_ARGS__)
#define SRC1_INDIRECT_LANE0(...) PP_MACRO_OVERLOAD(SRC_INDIRECT_LANE0, __VA_ARGS__)
#define SRC2_INDIRECT_LANE0(...) PP_MACRO_OVERLOAD(SRC_INDIRECT_LANE0, __VA_ARGS__)
#define SRC_INDIRECT_LANE0_0()  complex_ADDR_3D((uint32_t) SRC_SEL_INDIRECT_LS_LANE0, 0, 0, 0, 0)
#define SRC_INDIRECT_LANE0_3(alpha, beta, gamma)  complex_ADDR_3D((uint32_t) SRC_SEL_INDIRECT_LS_LANE0, 0, alpha, beta, gamma)

#define SRC_INDIRECT_LANE1(...) PP_MACRO_OVERLOAD(SRC_INDIRECT_LANE1, __VA_ARGS__)
#define SRC1_INDIRECT_LANE1(...) PP_MACRO_OVERLOAD(SRC_INDIRECT_LANE1, __VA_ARGS__)
#define SRC2_INDIRECT_LANE1(...) PP_MACRO_OVERLOAD(SRC_INDIRECT_LANE1, __VA_ARGS__)
#define SRC_INDIRECT_LANE1_0()  complex_ADDR_3D((uint32_t) SRC_SEL_INDIRECT_LS_LANE1, 0, 0, 0, 0)
#define SRC_INDIRECT_LANE1_3(alpha, beta, gamma)  complex_ADDR_3D((uint32_t) SRC_SEL_INDIRECT_LS_LANE1, 0, alpha, beta, gamma)
...
constexpr uint32_t SRC_CHAINING_2D(uint32_t id) {
    return (SRC_SEL_NEIGHBOR << ISA_COMPLEX_LENGTH_2D) | CHAIN_ID_2D(id);   // TODO: select is irrelevant in Hardware!
}
constexpr uint32_t SRC_CHAINING_3D(uint32_t id) {
    return (SRC_SEL_NEIGHBOR << ISA_COMPLEX_LENGTH_3D) | CHAIN_ID_3D(id);
}
...
constexpr uint32_t SRC_CHAINING_NEIGHBOR_2D = PREPEND_SEL_2D(SRC_SEL_NEIGHBOR);
 ...
 * 3D
 */
// use chaining from neighbor processing lane
constexpr uint32_t SRC_CHAINING_NEIGHBOR_LANE = PREPEND_SEL_3D(SRC_SEL_NEIGHBOR);
// use chaining from local LS
...
// TODO: remove deprecated followings
constexpr uint32_t  SRC1_CHAINING_LEFT_2D = SRC_CHAINING_NEIGHBOR_2D;
constexpr uint32_t  SRC1_CHAINING_RIGHT_2D = SRC_CHAINING_NEIGHBOR_2D;
constexpr uint32_t  SRC1_LS_2D = SRC_LS_2D;
constexpr uint32_t  SRC1_DONT_CARE_2D = SRC_DONT_CARE_2D;

constexpr uint32_t  SRC2_CHAINING_LEFT_2D = SRC_CHAINING_NEIGHBOR_2D;
constexpr uint32_t  SRC2_CHAINING_RIGHT_2D = SRC_CHAINING_NEIGHBOR_2D;
constexpr uint32_t  SRC2_LS_2D = SRC_LS_2D;
constexpr uint32_t  SRC2_DONT_CARE_2D = SRC_DONT_CARE_2D;

constexpr uint32_t  SRC_CHAINING_LEFT_2D = SRC_CHAINING_NEIGHBOR_2D;
constexpr uint32_t  SRC_CHAINING_RIGHT_2D = SRC_CHAINING_NEIGHBOR_2D;

constexpr uint32_t  SRC1_CHAINING_LEFT_3D = SRC_CHAINING_NEIGHBOR_LANE;
constexpr uint32_t  SRC1_CHAINING_RIGHT_3D = SRC_CHAINING_NEIGHBOR_LANE;
constexpr uint32_t  SRC1_LS_3D = SRC_LS_3D;
constexpr uint32_t  SRC1_DONT_CARE_3D = SRC_DONT_CARE_3D;

constexpr uint32_t  SRC2_CHAINING_LEFT_3D = SRC_CHAINING_NEIGHBOR_LANE;
constexpr uint32_t  SRC2_CHAINING_RIGHT_3D = SRC_CHAINING_NEIGHBOR_LANE;
constexpr uint32_t  SRC2_LS_3D = SRC_LS_3D;
constexpr uint32_t  SRC2_DONT_CARE_3D = SRC_DONT_CARE_3D;

constexpr uint32_t  SRC_CHAINING_LEFT_3D = SRC_CHAINING_NEIGHBOR_LANE;
constexpr uint32_t  SRC_CHAINING_RIGHT_3D = SRC_CHAINING_NEIGHBOR_LANE;
